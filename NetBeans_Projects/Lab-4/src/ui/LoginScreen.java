...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmbRoles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrater", "Supplier" }));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       ...
       if(selectedPanel.getClass()==SupplierWorkAreaJPanel.class){
           ...
           JOptionPane.showMessageDialog(this, "Please select a supplier to Login under supplier roles");
           return;
       }else{
