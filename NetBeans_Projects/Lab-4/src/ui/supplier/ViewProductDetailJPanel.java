...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewProductDetailJPanel(JPanel workArea, Product product,Supplier supplier, Feature feature) {
        initComponents();
    ...
    private void saveFeatures() {
        ...
        for (int i =0; i < model.getRowCount(); i++){
            ...
            product.addFeature(currentFeature);
    ...
    int selectedrow = tblFeatures.getSelectedRow();
        if(selectedrow<0) {
            JOptionPane.showMessageDialog(this, "Please select row from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
